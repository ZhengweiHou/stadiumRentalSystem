...
public class PageStore {
	...
	static{
		...
		pages.put("newsManager", new BackPage("newsManager", "公告管理", "/admin/backPage/newsManager.jsp"));
		pages.put("orderManager", new BackPage("orderManager", "订单管理", "/admin/backPage/orderManager.jsp"));
		}
}
